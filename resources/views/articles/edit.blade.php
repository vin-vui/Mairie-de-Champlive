                ...
                <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            ...
                            <div class="form-group">
                                <textarea class="form-control w-full text-black" rows="6" name="date" value="{{ $article->date }}" placeholder="Contenu"></textarea>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            <label class="font-bold text-lg">Lieu :</label>
                            <div class="form-group">
                                <textarea class="form-control w-full text-black" rows="6" name="location" value="{{ $article->location }}" placeholder="Contenu"></textarea>
                            </div>
                        </div>
