                ...
                <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            ...
                            <input class="form-control w-full text-black" rows="6" name="content"
                                value="{{ $article->content }}" placeholder="Description"></input>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            <label class="font-bold text-lg">Date </label>
                            <input class="form-control w-full text-black" rows="6" name="date" type="date"
                                value="{{ $article->date }}" placeholder="Contenu"></input>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            <label class="font-bold text-lg">Lieu </label>
                            <input class="form-control w-full text-black" rows="6" name="location"
                                value="{{ $article->location }}" placeholder="Contenu"></input>
                        </div>
