                ...
                <form action="{{ route('associations.update', $association->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            ...
                            <input class="form-control w-full h-36 text-black" rows="6" name="presentation"
                                value="{{ $association->presentation }}"
                                placeholder="Présentation de l'association"></input>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            <label class="font-bold text-lg">Contact</label>
                            <input class="form-control w-full text-black" rows="6" name="contact"
                                value="{{ $association->contact }}" placeholder="Contact"></input>
                        </div>
