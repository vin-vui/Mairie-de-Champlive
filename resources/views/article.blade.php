...
<body class="bg-seasalt ">
    <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-seasalt antialiased mx-12">
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl relative my-44 lg:my-32">
