...
<body class="font-sans antialiased">
    ...
    <div class="antialiased bg-peach dark:bg-gray-900">
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center justify-between mr-4">
                        ...
                        <span class="self-center flex justify-center text-peach text-2xl font-semibold whitespace-nowrap dark:text-white">Mairie de Champlive</span>
                    </a>
                        ...
                        <li>
                            <a href=""
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 14 14">
                                    <g fill="none" stroke="#ffe6a7" stroke-linecap="round" stroke-linejoin="round">
        ...
        <main class="p-4 md:ml-64 min-h-screen pt-20 bg-peach">
            {{$slot}}
        </main>
    </div>
