            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center justify-between mr-4">
                        ...
                        <span class="self-center flex justify-center text-seasalt text-2xl font-semibold whitespace-nowrap">Mairie de Champlive</span>
                    </a>
                </div>
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            <span class="inline-flex rounded-md">
                                <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-seasalt bg-carribean hover:underline transition ease-in-out duration-150">
                                    {{ Auth::user()->name }}
