    ...
    <body>
        <div class="relative my-32">
            ...
            <div class="border-2 border-carribean rounded-xl shadow-lg shadow-carribean mx-10 lg:w-2/3 lg:mx-auto">
                ...
                <div class="border-b-2 border-carribean/40 py-4 flex justify-between items-center px-10">
                    <img class="w-16" src="image/badge-de-sheriff.png" alt="">
                    <div class="font-p font-semibold text-smocky-black text-lg">
                        Police
                    </div>
                    <div class="font-h1 text-2xl text-smocky-black font-semibold">
                ...
                <div class="border-b-2 border-carribean/40 py-4 flex justify-between items-center px-10">
                    <img class="w-16" src="image/appel-durgence.png" alt="">
                    <div class="font-p font-semibold text-smocky-black text-lg">
                        Samu
                    </div>
                    <div class="font-h1 text-2xl text-smocky-black font-semibold">
                ...
                <div class="border-b-2 border-carribean/40 py-4 flex justify-between items-center px-10">
                    <img class="w-16" src="image/112.png" alt="">
                    <div class="font-p font-semibold text-smocky-black text-lg">
                ...
                <div class="border-b-2 border-carribean/40 py-4 flex justify-between items-center px-10">
                    <img class="w-16" src="image/violent.png" alt="">
                    <div class="font-p font-semibold text-smocky-black text-lg">
                        Enfance maltraitée
                    </div>
                    <div class="font-h1 text-2xl text-smocky-black font-semibold">
                ...
                <div class="border-b-2 border-carribean/40 py-4 flex justify-between items-center px-10">
                    <img class="w-16" src="image/violence-physique.png" alt="">
                    <div class="font-p font-semibold text-smocky-black text-lg">
                ...
                <div class="border-b-2 border-carribean/40 py-4 flex justify-between items-center px-10">
                    <img class="w-16" src="image/harcelement-scolaire.png" alt="">
                    <div class="font-p font-semibold text-smocky-black text-lg">
