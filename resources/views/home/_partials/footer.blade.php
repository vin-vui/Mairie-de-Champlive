<footer>
    ...
    <div class="bg-gradient-to-b from-mint to-carribean/90 flex flex-col text-center lg:text-justify lg:flex-row lg:justify-around py-16 text-seasalt font-p font-semibold">
        <div class="my-5">
        ...
        <div class="my-5">
            ...
            <div class=" leading-8 flex flex-col lg:ml-10">
                <div class="flex items-center justify-center lg:justify-normal">
                    <svg class="" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 16">
                    ...
                    <div class="ml-3">03 81 55 27 67</div>
                </div>

                <div class="flex items-center justify-center lg:justify-normal hover:underline">
