            ...
            @foreach ($associations as $association)
                <div class="grid max-w-screen-lg px-4 py-8 mx-auto my-24 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 border-2 border-carribean rounded-xl shadow-xl shadow-carribean/50">
                    <div class="mr-auto place-self-center lg:col-span-7">
                        <h1
                            class="max-w-2xl mb-4 text-4xl font-semibold tracking-tight leading-none font-h2">
                            {{ $association->name }}</h1>
                        <div
                            class="max-w-2xl mb-6 font-light text-base text-gray-500 lg:mb-8 font-p">
                        ...
                        <div
                            ...
                            <svg class="mr-4" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 16">
                    ...
                    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex ">
                        <img class="w-96 lg:rounded-lg" src="{{ Storage::url($association->image) }}" alt="{{ $association->name }}">
                    </div>
                </div>
            @endforeach
