    ...
    <body class="mx-24 bg-seasalt">
        ...
        <div class="mx-10 md:flex md:flex-wrap md:justify-center ">
            @foreach ($newspapers as $newspaper)
                <div class="flex border-2 border-carribean rounded-lg mb-8 p-5 md:mx-8 shadow-lg shadow-carribean/50 ">

                    <img class="w-32 mr-6" src="/image/news.png" alt="">
                    <div class="flex flex-col content-between">
                        <div class="font-h2 uppercase font-semibold mb-8 mt-5 ">{{ $newspaper->title }}</div>
                        <div class="mx-auto">
