<x-app-layout>
    ...
    <div class="m-10">
        <div class="pb-3 flex justify-end items-center bg-seasalt">
            <a class="border-2 border-carribean bg-carribean text-seasalt rounded-xl p-2 px-5 hover:text-carribean hover:font-bold hover:bg-seasalt" href="{{ route('galleries.create') }}">
                Ajouter une photo</a>
        </div>
        <div class="row mt-2">
