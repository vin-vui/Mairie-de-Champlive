    ...
    <div class="m-10">
        ...
        <div class="row mt-2">
            ...
            <div class="col-lg-12 border-2 border-carribean p-4 rounded-xl bg-seasalt text-smocky-black drop-shadow-2xl">
                ...
                <form action="{{ route('deliberations.update', $deliberation->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            ...
                            <input type="text" name="title" value="{{ $deliberation->title }}"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pb-5">
                            ...
                            <input class="form-control w-full text-black" rows="6" name="date" type="date"
                                value="{{ $deliberation->date }}" placeholder="Date"></input>
                        </div>
